...
for student_info in students_exercise_completed:
  exercises_completed = student_info["exercise_points"]
  ...
  print(f"{student_info["name"]:30}{exercises_completed:<10}{student_info["exercise_points"]:<10}{student_info["exam_points"]:<10}{student_total:<10}{student_info["grade"]:<10}")